...
# Example run:
# ./dreamzsBD8.py ./Data/VB10_order32.fits --niter 30000 --ptoff --nchains 3
...
#                    action='store_true')
parser.add_argument('--modelfile', help='Name of model grid (default: ./CIFIST2011/btsettl-3.pkl.gz', default='./CIFIST2011/btsettl-3.pkl.gz')
parser.add_argument('--ptoff', help='Turn off parallel tempering? Default=False', default=False, action='store_true')
parser.add_argument('--niter', help='Number of iterations (default: 100000)', \
                   default=100000, type=int)
parser.add_argument('--nchains', \
                    help='DREAMZ # of chains(default: 5)', 
                    default=5, type=int)
...
infile = sourceName + '-' + order + '-gtmap2.txt'
