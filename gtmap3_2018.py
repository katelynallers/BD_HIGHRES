...
'''
Example run
./gtmap3.py ./Data/2MJ1615+4953_comb.fits
'''
...
parser.add_argument('--tlow', help='Lower limit on surface temperature (default = 850 K)', default=850., type=float)
parser.add_argument('--thigh', help='Lower limit on surface temperature (default = 2800 K)', default=2800., type=float)
...
protostarModels = load(fin, allow_pickle=True)
fin.close()
